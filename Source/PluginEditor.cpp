...
void CompressorBandControls::resized()
{
    ...
    auto createButtonControlBox = [](std::vector<Component*> comps)
        {
...
void CompressorBandControls::updateAttachments()
{
    ...
    BandType bandType = [this]()
        ...
        makeAttachmentHelper(soloButtonAttachment, names[Pos::Attack], soloButton);
        makeAttachmentHelper(muteButtonAttachment, names[Pos::Attack], muteButton);
